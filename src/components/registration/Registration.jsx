  ...
  return (
    <div className="container mx-auto mb-2 text-white px-6 py-8 md:p-0">
      ...
      <form name="submit-to-google-sheet" className='sm:w-2/3 md:w-3/6 lg:w-2/5 xl:w-2/6 space-y-1' method="post" ref={formRef} onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <label htmlFor="alasan">Alasan Masuk LDK?</label>
          <textarea type="textarea" className="form-control" value={personalMember.reason} id="alasan" name="alasan" placeholder="Alasanmu apa?" onChange={handleChange}></textarea>
        </div>
